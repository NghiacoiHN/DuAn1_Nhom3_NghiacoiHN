...
--XuatXu
CREATE TABLE XuatXu(
IDXX UNIQUEIDENTIFIER PRIMARY KEY DEFAULT NEWID(),
MaXX VARCHAR(20) UNIQUE,
TenNuoc NVARCHAR(30),
TinhTrang INT DEFAULT 0
)
GO
...
--LoaiSP_ChiTietSanPham
ALTER TABLE ChiTietSanPham ADD FOREIGN KEY (IDLSP) REFERENCES LoaiSP(IDLSP)
--XuatXu_ChiTietSanPham
ALTER TABLE ChiTietSanPham ADD FOREIGN KEY (IDXX) REFERENCES XuatXu(IDXX)
--GioHang-KhachHang
